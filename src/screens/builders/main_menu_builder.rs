...
pub struct BuiltMainMenu {
    ...
    pub encrypt_file_button: button::Button,
    pub decrypt_button: button::Button,
    pub decrypt_file_button: button::Button,
...
pub fn build_main_menu(main_window: &mut window::Window) -> BuiltMainMenu {
    ...
    let mut encrypt_file_button = button::Button::default()
        .with_size(150, 30)
        .with_pos(420, 250)
        .with_label("Encrypt File");
    encrypt_file_button.set_color(Color::from_hex(0x545454));
    encrypt_file_button.set_label_color(Color::White);
    encrypt_file_button.set_label_size(16);
    ...
    let mut decrypt_file_button = button::Button::default()
        .with_size(150, 30)
        .with_pos(420, 300)
        .with_label("Decrypt File");
    decrypt_file_button.set_color(Color::from_hex(0x545454));
    decrypt_file_button.set_label_color(Color::White);
    decrypt_file_button.set_label_size(16);
